    ...
    with st.container(border=True):
        ...
        if 脉诊参数:
            ...
            with col13b:
                ...
                左H1 = st.number_input("左H1", 0.0000, 100.0000, 0.0001)
                左H2 = st.number_input("左H2", 0.0000, 100.0000, 0.0001)
                左H4 = st.number_input("左H4", 0.0000, 100.0000, 0.0001)
                左H5 = st.number_input("左H5", 0.0000, 100.0000, 0.0001)
                左T = st.number_input("左T", 0.0000, 100.0000, 0.0001)
                左T1 = st.number_input("左T1", 0.0000, 100.0000, 0.0001)
                左T4 = st.number_input("左T4", 0.0000, 100.0000, 0.0001)
                左T5 = st.number_input("左T5", 0.0000, 100.0000, 0.0001)
            with col14b:
                st.markdown("**右手脉诊客观化参数**",)
                右H1 = st.number_input("右H1", 0.0000, 100.0000, 0.0001)
                右H2 = st.number_input("右H2", 0.0000, 100.0000, 0.0001)
                右H4 = st.number_input("右H4", 0.0000, 100.0000, 0.0001)
                右H5 = st.number_input("右H5", 0.0000, 100.0000, 0.0001)
                右T = st.number_input("右T", 0.0000, 100.0000, 0.0001)
                右T1 = st.number_input("右T1", 0.0000, 100.0000, 0.0001)
                右T4 = st.number_input("右T4", 0.0000, 100.0000, 0.0001)
                右T5 = st.number_input("右T5", 0.0000, 100.0000, 0.0001)
